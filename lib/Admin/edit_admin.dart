...
class EditAdmin extends StatefulWidget {
  ...
  const EditAdmin({Key key, this.id, this.email, this.nom}) : super(key: key);
  @override
...
class _EditAdminState extends State<EditAdmin> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  validator: (value) {
                    if (value.isEmpty) {
                      return "Vous devez saisir le nom d'administrateur";
                    } else if (value.length > 50) {
                      return 'le nom ne peut pas avoir plus de 50 lettres';
                    }
                  },
                ),
              ),
  ...
  void validateAndUpload() async {
    if (_formKey.currentState.validate()) {
      ...
      adminService.updateAdmin(name: NameController.text, email: emailController.text, uid:widget.id);
