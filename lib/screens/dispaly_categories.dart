...
class diplay_Cats extends StatefulWidget {
  @override
  _diplay_CatsState createState() => _diplay_CatsState();
}

class _diplay_CatsState extends State<diplay_Cats> {
  @override
  void initState() {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ListView.builder(
            itemCount: appProvider.Cats.length,
              ...
              return  Padding(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(appProvider.Cats[index].nom),
                    //subtitle: Text(""),
                    trailing:
                    PopupMenuButton<int>(
                      ...
                      onSelected: (result) {
                        if (result == 1) {
                          categoryService.deleteCat(appProvider.Cats[index].nom);
                        }
                        if (result == 2) {
                          ///  Pour ajouter edit
                        }
      ...
      actions: <Widget>[
        FlatButton(onPressed: (){
          if(categoryController.text != null){
            categoryService.createCat(categoryController.text);
          }
